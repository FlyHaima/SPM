...
import basicList from '@/components/risk-screening/finish-records-basic/list'
import productList from '@/components/risk-screening/finish-records-product/list'
export default {
  name: 'finishRecords',
  data () {
    return {
      breadcrumb: ['隐患排查治理', '完成记录'],
