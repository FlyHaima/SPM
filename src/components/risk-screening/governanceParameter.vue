...
import basicList from '@/components/risk-screening/governance-parameter-basic/list'
import productList from '@/components/risk-screening/governance-parameter-product/list'
export default {
  name: 'governanceParameter',
  data () {
    return {
      breadcrumb: ['隐患排查治理', '治理台账'],
