...
import basicList from '@/components/risk-screening/risk-management-basic/list'
import productList from '@/components/risk-screening/risk-management-product/list'
